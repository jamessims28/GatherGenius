...
export default function Page() {
  ...
  const [status, setStatus] = useState("Layer 4.1 full patched ready.");
      ...
      <div className="mx-auto max-w-7xl">
        <header className="card mb-6 flex flex-wrap justify-between gap-6 items-center">
          <div className="flex gap-5 items-center">
            <div className="orb" />
            <div>
              <p className="text-sm uppercase tracking-[.25em] text-stone-500">Layer 4.1 Full Patched</p>
        ...
        {tab === "marketplace" && (
          <>
            <section className="card mb-6">
              ...
              <p className="text-stone-500 mt-4 max-w-2xl">This full patched version uses Next.js 14.2.30 and includes Layer 4.1 activation tools.</p>
            </section>
        ...
        {tab === "dashboard" && (
          <section>
            ...
            <div className="card">
              <h3 className="text-2xl font-light">Layer 4.1 full patched is live</h3>
              <p className="text-stone-500 mt-2">Next.js 14.2.30 + Live Setup checks + Stripe/Supabase scaffolds are included.</p>
            </div>
          </section>
        )}
