...
export default function Page() {
  ...
  const [status, setStatus] = useState("Layer 4.1 ready: live activation checks added.");
      ...
      <div className="mx-auto max-w-7xl">
        <header className="card mb-6 flex flex-wrap justify-between gap-6 items-center">
          <div className="flex gap-5 items-center">
            <div className="orb" />
            <div>
              <p className="text-sm uppercase tracking-[.25em] text-stone-500">Layer 4.1 Live Activation</p>
        ...
        {tab === "marketplace" && (
          <>
            <section className="card mb-6">
              ...
              <p className="text-stone-500 mt-4 max-w-2xl">Layer 4.1 adds live activation checks so you can verify Stripe and Supabase.</p>
            </section>
        ...
        {tab === "dashboard" && (
          <section>
            ...
            <div className="card">
              <h3 className="text-2xl font-light">Layer 4.1 is live</h3>
              <p className="text-stone-500 mt-2">Use Live Setup to verify Stripe and Supabase connection status.</p>
            </div>
          </section>
        )}
