...
export default function Page() {
  ...
  const [status, setStatus] = useState("Vercel-ready payment system loaded");
  ...
  async function createGuestPayment(member) {
    ...
    try {
      ...
      setStatus("Payment route error. Check deployment logs.");
    }
    setLoading("");
  }
  ...
  async function createSubscription(plan) {
    ...
    try {
      ...
      setStatus("Subscription route error. Check deployment logs.");
    }
    setLoading("");
  }
  ...
  async function savePayment(member) {
    ...
    try {
      ...
      setStatus("Save route error. Check deployment logs.");
    }
    setLoading("");
  }
  ...
  async function sendReceipt(member) {
    ...
    try {
      ...
      setStatus("Receipt route error. Check deployment logs.");
    }
    setLoading("");
  }
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8">
        <header className="flex justify-between items-center mb-10">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-3xl font-black">GatherGenius</h1><p className="text-yellow-200/70">Vercel-Ready Payment Build</p></div>
          </div>
        ...
        <section className="grid lg:grid-cols-3 gap-6 mb-10">
          <div className="lg:col-span-2 rounded-[2rem] bg-gray-950/80 border border-gray-800 p-6">
            <h2 className="text-3xl font-black mb-2">Guest Split Payments</h2>
            <p className="text-gray-400 mb-6">Create Stripe payment links, save payments, and send receipts.</p>
