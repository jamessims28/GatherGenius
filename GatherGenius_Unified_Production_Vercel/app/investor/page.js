  ...
  return (
    <main className="gg-shell">
      <nav className="gg-nav">
        ...
        <div className="gg-actions"><a className="gg-pill" href="/">Home</a><a className="gg-pill" href="/execution">Execution</a><a className="gg-pill" href="/vendor">Vendor</a></div>
      </nav>
      <section className="gg-section">
        <div className="gg-card">
          <span className="gg-status good">Investor Proof</span>
          <h2 style={{ marginTop: 16, fontFamily: "var(--font-playfair), Georgia, serif", fontSize: 54, letterSpacing: "-.06em" }}>GatherGenius removes planning.</h2>
          <p className="gg-note">The platform converts one sentence or taps into a locked event outcome and executes it with vendors, backups, SLA, payments, and data feedback.</p>
