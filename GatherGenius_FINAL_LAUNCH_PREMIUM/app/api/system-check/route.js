...
export async function GET() {
  ...
  return NextResponse.json({ ok: true, connected: Object.values(checks).every(Boolean), checks, message: "System check complete. Missing keys use safe fallback mode." });
}
