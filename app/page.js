      ...
      <main className="gg-shell">
        ...
        <section className="gg-hero">
          <div className="gg-inner">
            ...
            <div className="gg-card" style={{ width: "min(1040px,100%)", margin: "14px auto 0", textAlign: "left" }}>
              <span className="gg-status good">Tap Input</span>
              <h3 style={{ marginTop: 16 }}>No speaking. No typing. No thinking.</h3>
              <p className="gg-note">Tap selections instantly build the correct one-sentence experience prompt.</p>
