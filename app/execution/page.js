  ...
  return (
    <main className="gg-shell">
      <nav className="gg-nav">
        ...
        <div className="gg-actions"><BackButton /><a className="gg-pill" href="/">Home</a><a className="gg-pill" href="/provider">Provider</a><a className="gg-pill" href="/investor">Investor</a></div>
      </nav>
