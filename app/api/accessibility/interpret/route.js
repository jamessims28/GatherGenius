...
export async function POST(req) {
  ...
  return NextResponse.json({ ok: true, message: "Accessibility input converted to experience intent.", intent: { inputMode: body.mode || "tap", eventType, vibe, guests, budget, location, prompt } });
}
