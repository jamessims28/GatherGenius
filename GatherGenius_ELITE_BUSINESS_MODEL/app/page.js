  ...
  return (
    <main className="min-h-screen p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="elite-card flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        ...
        <section className="grid gap-6 lg:grid-cols-12">
          <aside className="elite-card lg:col-span-3 h-fit">
            ...
            <div className="mt-5 rounded-2xl border bg-white p-4 text-xs text-stone-500">
              Elite presentation mode with dropdowns, borders, business model table, automation routes, and investor-safe metrics.
            </div>
          </aside>

          <div className="lg:col-span-9 space-y-6">
            <section id="overview" className="elite-card">
