      ...
      <main className="gg-shell">
        <motion.nav className="gg-nav" initial={reducedMotion ? false : { opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
          ...
          <div className="gg-actions">
            ...
            <a className="gg-pill" href="/permissions">Permissions</a>
        ...
        <section className="gg-hero">
          <div className="gg-inner">
            ...
            <p className="gg-sub">Use one sentence or voice. GatherGenius quietly applies the right templates in the background.</p>
            ...
            <div className="gg-background-intel">
              <span className="gg-status good">Background Intelligence</span>
              <p className="gg-note">
                Templates are now hidden. GatherGenius references experience types, vibes, provider stacks, budget models, and accessibility preferences silently in the background.
              </p>
            </div>
