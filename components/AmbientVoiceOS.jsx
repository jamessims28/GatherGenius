...
const states = {
  ...
  thinking: {
    ...
    message: "I’m quietly matching templates, providers, pricing, and permissions."
  },
  building: {
    label: "Building",
    prompt: "I’m building the experience.",
    message: "Provider stack, budget, backup coverage, and confidence are forming now."
  },
  confident: {
    label: "Confidence",
...
export default function AmbientVoiceOS({ onBuild }) {
  ...
  async function runVoiceFlow() {
    ...
    setConversation((items) => [
      ...items,
      { role: "GatherGenius", text: "I built the first version. Templates stayed in the background. Confidence is 94%. You can lock it when ready." }
    ]);
